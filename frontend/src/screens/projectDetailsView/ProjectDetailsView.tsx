...
export const ProjectDetailsView = () => {
  ...
  return (
    <div className="min-h-screen bg-background pt-20">
      <header className="bg-sidebar-bg container mx-auto mx-auto border-b border-border px-4 md:px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-base md:text-lg font-semibold text-foreground">LegalDocs</span>
            </div>
        ...
        <div className="mt-4 flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 text-xs md:text-sm">
          <span className="text-foreground font-medium">Thompson v Metropolitan Shopping Centers Pty Ltd</span>
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-muted-foreground">
            ...
            <span className="hidden lg:inline">📋 18 Motions to March 2025</span>
            <span className="hidden xl:inline">📑 Premises Liability • County Court Victoria</span>
          </div>
        </div>
      </header>
      ...
      <div className="flex container mx-auto">
        ...
        {rightSidebarOpen && (
          <div className="fixed inset-0 z-50 md:hidden">
            <div className="fixed inset-0 bg-black/50" onClick={() => setRightSidebarOpen(false)} />
            <div className="fixed right-0 top-0 h-full w-80 max-w-[80vw]">
              <div className="flex items-center justify-between p-4 bg-sidebar-bg border-b">
                <span className="font-semibold text-foreground">Case Details</span>
                <Button
                  variant="ghost"
                  size="sm"
